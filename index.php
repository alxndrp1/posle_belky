...
<html lang="ru">
  ...
  <body>
      ...
      <?php // L-101589 GCJ9drtg ftp-179628.srv.hoster.ru srv179628 p6CB938b
        session_start();
...
<?php endif; ?>
                <?php
                  ...
                  if(isset($_GET["dcol"]))
                  {
                    if($db->querySingle("SELECT crow FROM mcols WHERE col=".$_GET["dcol"].";") > 1)
                      $db->exec("UPDATE mcols SET crow = crow - 1 WHERE col=".$_GET["dcol"].";");
                  }
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <p>3. Если в комбинируемой последовательности попадается символ <b>"Ø"</b> или <b>"ø"</b>, последовательность обрезается до этого символа.</p>
                  <p>4. Чтобы создать комбинирующийся участок, необходимо уменьшить кол-во ячеек для элементов на величену элементов участка и записать элементы участка в одну ячейку слитно.</p>
                </div>
